...
namespace MAV3DSim
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MAV3DSim.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(MAV3DSim.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(MAV3DSim.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
        ...
        public void SetPitchAngle(double aircraftPitchAngle)
        {
            PitchAngle = aircraftPitchAngle;
            this.Refresh();
        }

        public void SetRollAngle(double aircraftRollAngle)
        {
            RollAngle = aircraftRollAngle * Math.PI / 180; ; 
            this.Refresh();
        }
